...
], CreateAppointmentDto.prototype, "clinicianId", void 0);
__decorate([
...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: ['requested', 'confirmed', 'completed', 'cancelled'] }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsIn)(['requested', 'confirmed', 'completed', 'cancelled']),
    __metadata("design:type", String)
