...
let AdminController = class AdminController {
    ...
    updateConsent(patientId, facilityId, granted) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], AdminController.prototype, "getConsents", null);
__decorate([
    (0, common_1.Patch)('patients/:patientId/consents'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    __param(0, (0, common_1.Param)('patientId')),
    __param(1, (0, common_1.Body)('facilityId')),
    __param(2, (0, common_1.Body)('granted')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, Boolean]),
    __metadata("design:returntype", void 0)
], AdminController.prototype, "updateConsent", null);
exports.AdminController = AdminController = __decorate([
    (0, swagger_1.ApiTags)('Admin & Consents'),
